...
class _AddNewPostAuctionPageState<V> extends State<AddNewAuctionPage> {
  ...
  Price _price = null;
  String _payment = "Payment.pouzecem";
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: new InputDecoration(
                ...
                labelText: "Početna cena u dinarima",
                labelStyle: TextStyle(
                  color: Color(0xff59081b),
                ),
              ),
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: new InputDecoration(
                ...
                labelText: "Krajnja cena u dinarima",
                labelStyle: TextStyle(
                  color: Color(0xff59081b),
                ),
              ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              child: Text(
                            "  Uneti koliko dana traje licitacija. Licitacija ne može trajati manje od 3 dana i više od 10 dana",
                            style: TextStyle(
                              color: Color(0xff59071a),
                              fontWeight: FontWeight.w400,
                              fontSize: 16.0,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      await list.addPoster(
                          ...
                          kategorija,
                          potkategorija,
                          pocetnacena.text + "|" + krajnjacena.text,
                          licitacija.text,
                          "Payment.pouzecem",
                          list.posters.length,
                          DateTime.now().day,
                    ...
                    children: [
                      ...
                      Container(
                        child:Center(
                          ...
                          child: RaisedButton(
                            color:  Color(0xff59071a),
                            child: Text("Kategorija", style: TextStyle(color: Colors.white)),
                            onPressed: () =>
                      ...
                      Container(
                        child:Center(
                          ...
                          child: RaisedButton(
                            color:  Color(0xff59071a),
                            child: Text("Podkategorija", style: TextStyle(color: Colors.white),),
                            onPressed: () =>
                      ...
                      Container(
                        child: Row(
                          children: [
                            Text("Trajanje licitacije: "),
                            trajanjeLicitacije(),
                          ],
                        ),
                      ),
                      Container(child: Text("NAPOMENA: Uneti koliko dana!", textScaleFactor: 0.7,),),
                      SizedBox(
                        height: 10.0,
                      ),
                      Column(
                        children: <Widget>[
                          ...
                          ListTile(
                            title: const Text('Pouzecem', textScaleFactor: 0.8,),
                          ...
                          ListTile(
                            title: const Text('Kriptovalutama', textScaleFactor: 0.8,),
                            leading: Radio<Payment>(
                          ...
                          ListTile(
                            title: const Text('Sve', textScaleFactor: 0.8,),
                            leading: Radio<Payment>(
                              value: Payment.sve,
                              groupValue: _payment,
                              onChanged: (Payment value) {
