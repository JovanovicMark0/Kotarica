...
//1
  ...
  getImageURL(drugiKorisnik) {
    lista = list.loadDates([]);
    var idKorisnika = drugiKorisnik.id;
    uss.Date usingUserDate;
    for (var i = 0; i < lista.length; i++) {
      if (lista[i].id == idKorisnika) {
        usingUserDate = lista[i];
        break;
      }
    }
    return usingUserDate.pictures;
  }
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ConversationList(
                ...
                imageUrl: emailPref == svePoruke[index].receiver
                    ? "http://147.91.204.116:11128/ipfs/" +
                        getImageURL(senderPref(svePoruke[index].sender))
                    : "http://147.91.204.116:11128/ipfs/" +
                        getImageURL(senderPref(svePoruke[index].receiver)),
                ...
                newMessage: (index == 0 || index == 3) ? false : false,
              );
            },
          ),
        ]),
